    ...
    <SectionBlock bgColor="bg-main-light" paddingY="py-0" className="relative overflow-hidden">
      <div className="mx-auto max-w-6xl">
        <div className="flex flex-col md:flex-row md:items-center">
          ...
          <div className="w-full py-12 md:w-1/2 md:py-24">
            <div className="mb-6 flex justify-start">
              {doctorImage && (
                <div className="h-24 w-24 overflow-hidden rounded-full bg-gray-300 md:h-48 md:w-48">
                  <Image
                    src={doctorImage}
            ...
            {doctorDescription && (
              <p className="mb-8 max-w-lg text-gray-700">{doctorDescription}</p>
            )}
          ...
          <div className="h-full w-full md:absolute md:top-0 md:right-0 md:w-1/2">
            {backgroundImage && (
